...
def generate_constraints(subject_id: str, relation: str, new_target_id: str):
    constraints = []
    ...
    if relation == 'mother':
        ...
        mothers_children = subject_relation_to_targets(new_target_id, our_relations['child'])
        father_options = subject_relation_to_targets(subject_id, our_relations['father'])
        father_children = []
        for father in father_options:
            father_children += subject_relation_to_targets(father, our_relations['child'])
